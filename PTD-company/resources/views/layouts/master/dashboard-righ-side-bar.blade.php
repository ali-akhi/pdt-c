                    ...
                    <ul class="setting-list list-unstyled m-t-20">
                            ...
                            <div class="form-check">
                                <div class="form-check m-l-10">
                                    <label class="form-check-label">
                                        <input class="form-check-input" type="checkbox" value checked> ذخیره
                                        تاریخچه
                        ...
                        <li>
                            <div class="form-check">
                                <div class="form-check m-l-10">
                                    <label class="form-check-label">
                                        <input class="form-check-input" type="checkbox" value checked> نمایش
                                        وضعیت
                                        <span class="form-check-sign">
                                            <span class="check"></span>
                                        </span>
                        ...
                        <li>
                            <div class="form-check">
                                <div class="form-check m-l-10">
                                    <label class="form-check-label">
                                        <input class="form-check-input" type="checkbox" value checked> ثبت
                                        مسئله خودکار
                                        <span class="form-check-sign">
                                            <span class="check"></span>
                                        </span>
