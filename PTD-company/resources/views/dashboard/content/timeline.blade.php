    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index_15.html">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <ul class="breadcrumb breadcrumb-style ">
                            <li class="breadcrumb-item">
                                <h4 class="page-title">خط زمانی</h4>
                            </li>
                            ...
                            <li class="breadcrumb-item active">خط زمانی</li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="body">
                        <section id="cd-timeline" class="cd-container">
                            <div class="cd-timeline-block">
                                ...
                                <div class="cd-timeline-content">
                                    <h2 class="timelineLabelColor">
                                        <strong>آرش خادملو</strong> یک وضعیت به روز رسانی ارسال کرد</h2>
                                    <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است</p>
                                    <a href="#0" class="cd-read-more">ادامه مطلب</a>
                                    <span class="cd-date">14 تیر</span>
                                </div>
                                <!-- cd-timeline-content -->
                            </div>
                            <!-- cd-timeline-block -->
                            <div class="cd-timeline-block">
                                ...
                                <div class="cd-timeline-content">
                                    <h2 class="timelineLabelColor">
                                        <strong>پیام جدید</strong> از پریانکا</h2>
                                    <p>سلام ... لطفا مکان خود را به اشتراک بگذارید.</p>
                                </div>
                                <!-- cd-timeline-content -->
                            </div>
                            <!-- cd-timeline-block -->
                            <div class="cd-timeline-block">
                                ...
                                <div class="cd-timeline-content">
                                    <h2 class="timelineLabelColor">
                                        <strong>آرش خادملو</strong> مکان به اشتراک بگذارید</h2>
                                    <div class="col-lg-12">
                                        <div class="map m-t-10">
                                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d387190.2798893698!2d-74.25986762659859!3d40.697670067978756!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c24fa5d33f083b%3A0xc80b8f06e177fe62!2sNew+York%2C+NY%2C+USA!5e0!3m2!1sen!2sin!4v1520161357422"></iframe>
                                        </div>
                                    </div>
                                    <span class="cd-date">14 تیر</span>
                                </div>
                            ...
                            <div class="cd-timeline-block">
                                ...
                                <div class="cd-timeline-content">
                                    <h2 class="timelineLabelColor">
                                        <strong>شیلا جیمز</strong> 3 عکس اضافه شد</h2>
                                    <div class="row">
                                        <div class="col-lg-3 col-md-6 col-6">
                                            <a href="#" onClick="return false;">
                                                <img src="images/3.jpg" alt class="img-fluid img-thumbnail m-t-30">
                                            </a>
                                        </div>
                                        <div class="col-lg-3 col-md-6 col-6">
                                            <a href="#" onClick="return false;">
                                                <img src="images/4.jpg" alt class="img-fluid img-thumbnail m-t-30">
                                            </a>
                                        </div>
                                        <div class="col-lg-3 col-md-6 col-6">
                                            <a href="#" onClick="return false;">
                                                <img src="images/5.jpg" alt class="img-fluid img-thumbnail m-t-30">
                                            </a>
                                        </div>
                                    </div>
                                    <span class="cd-date">14 تیر</span>
                            ...
                            <div class="cd-timeline-block">
                                ...
                                <div class="cd-timeline-content">
                                    <h2 class="timelineLabelColor">
                                        <strong>جینا پاتیل</strong> در مورد عکس ها نظر داد</h2>
                                    <p>کلیک خوب !!!</p>
                                    <span class="cd-date">18 تیر</span>
                                </div>
                                <!-- cd-timeline-content -->
                            </div>
                            <!-- cd-timeline-block -->
                            ...
                            <div class="cd-timeline-block">
                                <div class="cd-timeline-img cd-picture">
                                    <img src="images/user8.jpg" alt="User">
                                </div>
                                <!-- cd-timeline-img -->
                                <div class="cd-timeline-content">
                                    <h2 class="timelineLabelColor">
                            ...
                            <div class="cd-timeline-block">
                                <div class="cd-timeline-img cd-location">
                                    <img src="images/user9.jpg" alt="User">
                                </div>
                                <!-- cd-timeline-img -->
                                <div class="cd-timeline-content">
                                    <h2 class="timelineLabelColor">
